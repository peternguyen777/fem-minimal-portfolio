      ...
      <div className='flex flex-col items-center sm:h-[80px] sm:flex-row sm:justify-between sm:px-10 xl:mx-auto xl:max-w-[1440px] xl:px-[165px]'>
        <div className='flex flex-col items-center sm:flex-row sm:items-center'>
          ...
          <div className='mb-10 flex flex-col items-center space-y-8 sm:mb-0 sm:ml-12 sm:flex-row sm:space-y-0 sm:space-x-[42px]'>
            <Link href='/'>
              <a className='font-publicsans text-[12px] leading-[14px] tracking-[2px] text-white hover:text-primary_cyan'>
                HOME
              </a>
            </Link>
            <Link href='/portfolio'>
        ...
        <div className='mb-14 flex items-center space-x-4 fill-[#fff] sm:mb-0'>
